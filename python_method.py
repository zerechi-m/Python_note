...
[a, b] = [int(a) * 2 for a in range(1, 3)]  # アンパックできる。標準入力でも可能
print([a, b])

# 10進数を2進数に変更 -------------------------

print( bin(203) )    # 10進数を２進数に変換するが b のプレフィックスがつく
print( format(203, 'b'))   # format( int, 'b' ) で b のプレフィックスを削除して表示

# 2.16 進数を10進数に変換

print( int('10001', 2)) # int(第一引数に 置き換えたい数字, 2進数の2)
print( int('c3', 16))